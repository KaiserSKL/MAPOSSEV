...
class Clientes extends MY_Controller
{
    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run('clientes') == false) {
            ...
            if ($this->clientes_model->add('clientes', $data) == true) {
                $this->session->set_flashdata('Éxito', '¡Cliente añadido exitosamente!');
                log_info('Adicionou um cliente.');
                redirect(site_url('clientes/'));
            } else {
                $this->data['custom_error'] = '<div class="form_error"><p>Se produjo un error.</p></div>';
            }
        }
    ...
    public function editar()
    {
        ...
        if (! $this->permission->checkPermission($this->session->userdata('permissao'), 'eCliente')) {
            $this->session->set_flashdata('error', 'No tienes permiso para editar clientes.');
            redirect(base_url());
        }
        ...
        if ($this->form_validation->run('clientes') == false) {
            ...
            if ($this->clientes_model->edit('clientes', $data, 'idClientes', $this->input->post('idClientes')) == true) {
                $this->session->set_flashdata('Éxito', '¡Cliente editado exitosamente!');
    ...
    public function visualizar()
    {
        ...
        if (! $this->permission->checkPermission($this->session->userdata('permissao'), 'vCliente')) {
            $this->session->set_flashdata('error', 'No tienes permiso para ver clientes.');
            redirect(base_url());
        }
    ...
    public function excluir()
    {
        if (! $this->permission->checkPermission($this->session->userdata('permissao'), 'dCliente')) {
            $this->session->set_flashdata('error', 'No tienes permiso para eliminar clientes.');
            redirect(base_url());
        }

        $id = $this->input->post('id');
        if ($id == null) {
            $this->session->set_flashdata('error', 'Error al intentar eliminar el cliente.');
        ...
        $this->session->set_flashdata('Éxito', '¡Cliente eliminado exitosamente!');
        redirect(site_url('clientes/gerenciar/'));
    }
}
