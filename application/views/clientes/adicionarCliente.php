            ...
            <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form-horizontal">
                <div class="widget-content nopadding tab-content">
                    <div class="span6">
                        ...
                        <div class="control-group">
                            <label for="nomeCliente" class="control-label">Nombre/Nombre de la empresa<span class="required">*</span></label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label for="celular" class="control-label">Extensión</label>
                            <div class="controls">
