        ...
        <form class="span9" method="get" action="<?= base_url() ?>index.php/clientes"
            ...
            <div class="span3">
                <input type="text" name="pesquisa" id="pesquisa"
                    placeholder="Buscar por Nombre, Email o Telefono..." class="span12"
                ...
                <tbody>
                    ...
                    foreach ($results as $r) {
                        ...
                        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vCliente')) {
                            ...
                            echo '<a href="' . base_url() . 'index.php/mine?e=' . $r->email . '" target="new" style="margin-right: 1%" class="btn-nwe2" title="Área del cliente"><i class="bx bx-key bx-xs"></i></a>';
                        }
...
<div id="modal-excluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <form action="<?php echo base_url() ?>index.php/clientes/excluir" method="post">
        ...
        <div class="modal-body">
            ...
            <h5 style="text-align: center">¿Realmente desea eliminar este cliente y los datos asociados a él (SO, Ventas, Ingresos)?</h5>
        </div>
        <div class="modal-footer" style="display:flex;justify-content: center">
            ...
            <button class="button btn btn-danger"><span class="button__icon"><i class='bx bx-trash'></i></span> <span
                    class="button__text2">Eliminar</span></button>
        </div>
    </form>
</div>
