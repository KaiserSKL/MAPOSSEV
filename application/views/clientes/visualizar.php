<div class="widget-box">
    <div class="widget-title" style="margin: 0;font-size: 1.1em">
        <ul class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#tab3">Ventas</a></li>
        </ul>
    </div>
                    ...
                    <div class="collapse in accordion-body" id="collapseGOne">
                        <div class="widget-content">
                            <table class="table table-bordered" style="border: 1px solid #ddd">
                                ...
                                <tr>
                                    <td style="text-align: right"><strong>Tipo de Cliente</strong></td>
                                    <td>
                    ...
                    <div class="accordion-heading">
                        <div class="widget-title">
                            <a data-parent="#collapse-group" href="#collapseGTwo" data-toggle="collapse">
                                ...
                                <h5 style="padding-left: 28px">Contacto</h5>
                            </a>
                        </div>
                    </div>
                    <div class="collapse accordion-body" id="collapseGTwo">
                        <div class="widget-content">
                            <table class="table table-bordered" style="border: 1px solid #ddd">
                                <tbody>
                                <tr>
                                    <td style="text-align: right; width: 30%"><strong>Enlace:</strong></td>
                                    <td>
                                ...
                                <tr>
                                    <td style="text-align: right"><strong>Extensión</strong></td>
                                    <td>
                    ...
                    <div class="collapse accordion-body" id="collapseGThree">
                        <div class="widget-content">
                            <table class="table table-bordered th" style="border: 1px solid #ddd;border-left: 1px solid #ddd">
                                ...
                                <tr>
                                    <td style="text-align: right"><strong>Referencias</strong></td>
                                    <td>
                                        <?php echo $result->complemento ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align: right"><strong>Colonia</strong></td>
                                    <td>
        ...
        <div id="tab2" class="tab-pane" style="min-height: 300px">
            <?php if (!$results) { ?>
                <table class="table table-bordered ">
                    ...
                    <tbody>
                    <tr>
                        <td colspan="6">No hay órdenes de servicio registradas</td>
                    </tr>
                    </tbody>
                </table>
                <?php
