    ...
    <div class="left-login">
      ...
      <h1 class="h-one">
        ...
        function saudacao($nome = '')
        {
            $hora = date('H');
            if ($hora >= 00 && $hora < 12) {
                return '¡Holá! Buenos Dias' . (empty($nome) ? '' : ', ' . $nome);
            } elseif ($hora >= 12 && $hora < 18) {
                return '¡Holá! Buenas Tardes' . (empty($nome) ? '' : ', ' . $nome);
            } else {
                return '¡Holá! Buenas Noches' . (empty($nome) ? '' : ', ' . $nome);
            }
        }
        $login = 'Bienvenido';
        echo saudacao($login);
          ...
          <div class="container">
            <div class="card">
              <div class="content">
                ...
                <div class="center">
                  <button id="btn-acessar">Acceder</button>
                </div>
                ...
                <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  ...
                  <div class="modal-body">
                    <h5 style="text-align: center" id="message">Los datos de acceso son incorrectos, ¡inténtelo de nuevo!</h5>
                  </div>
          ...
          $.ajax({
            ...
            success: function(data) {
                if (data.result == true) {
                    ...
                    $('#message').text(data.message || 'Los datos de acceso son incorrectos, ¡inténtelo de nuevo!');
