            ...
            <div class="row-fluid">
                <div class="span12">
                    <ul class="site-stats">
                        ...
                        <li class="bg_lb span12" style="margin-left: 0"><strong>Telefono:
                        ...
                        <li class="bg_lh span12" style="margin-left: 0; border-bottom-left-radius: 9px;border-bottom-right-radius: 9px"><strong>El acceso expira en:
                    ...
                    <form id="formSenha" action="<?= site_url('mapos/alterarSenha'); ?>" method="post">
                        ...
                        <div class="span12" style="margin-left: 0">
                            ...
                            <button class="button btn btn-primary" style="max-width: 140px;text-align: center">
                              <span class="button__icon"><i class='bx bx-lock-alt'></i></span><span class="button__text2">Cambiar</span></button>
                    </form>
                </div>
...
<div id="modalImageUser" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?= site_url('mapos/uploadUserImage'); ?>" id="formImageUser" enctype="multipart/form-data" method="post" class="form-horizontal">
        <div class="modal-header">
            ...
            <h3 id="">MapOS - Actualizar Imagen de Usuario</h3>
        </div>
        <div class="modal-body">
            <div class="span12 alert alert-info">Seleccione una nueva imagen de usuario. Tamaño recomendado: 130 x 130.</div>
