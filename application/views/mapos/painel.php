...
<script src='<?= base_url(); ?>assets/js/fullcalendar/locales/es-es.js'></script>
                    ...
                    <div id='source-calendar'>
                        <form method="post">
                            <select style="padding-left: 30px" class="span12" name="statusOsGet" id="statusOsGet" value="">
                                ...
                                <option value="Em Andamento">En curso</option>
                                <option value="Finalizado">Finalizado</option>
                                <option value="Cancelado">Cancelado</option>
                                <option value="Aguardando Peças">Esperando piezas</option>
        ...
        <div class="new-statisc">
            <div class="widget-box-new widbox-blak" style="height:100%">
                ...
                <div class="new-bottons">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/os/adicionar" class="card tip-top" title="Añadir OS">
                            ...
                            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'rFinanceiro')) : ?>
                                ...
                                <a href="<?php echo base_url() ?>index.php/financeiro/lancamentos" class="card tip-top" title="Adicionar receita">
                                    ...
                                    <div>
                                        ...
                                        <div class="cardName">Receta del día</div>
                                    </div>
                                </a>
                                ...
                                <a href="<?php echo base_url() ?>index.php/financeiro/lancamentos" class="card tip-top" title="Adiciona despesa">
                                    ...
                                    <div>
                                        ...
                                        <div class="cardName">Gastos diarios</div>
                                    </div>
                                </a>
                            <?php endif ?>
            ...
            <div class="new-balance">
                <div class="widget-box0">
                    <div class="widget-title2">
                        <h5 class="cardHeader">Revisión mensual de fin de año</h5>
                ...
                <div class="widget-box-statist">
                    <h5 class="cardHeader">Estatísticas Financieras</h5>
...
<div class="span12A" style="margin-left: 0">
    <div class="widget-box0 widbox-blak">
        <div>
            <h5 class="cardHeader">Órdenes de servicio en el presupuesto.</h5>
        </div>
        <div class="widget-content">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5">No hay OS en el presupuesto.</td>
                        </tr>
                    <?php endif ?>
                </tbody>
            </table>
        ...
        <div class="widget-content">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5">No hay OS abiertas.</td>
                        </tr>
                    <?php endif ?>
                </tbody>
            </table>
    ...
    <div class="widget-box0 widbox-blak">
        <div>
            <h5 class="cardHeader">Órdenes de servicio Aprobadas</h5>
        </div>
        <div class="widget-content">
            <table class="table table-bordered">
                <thead>
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5">No hay OS Aprobadas.</td>
                        </tr>
                    <?php endif ?>
                </tbody>
            </table>
    ...
    <div class="widget-box0 widbox-blak">
        <div>
            <h5 class="cardHeader">Órdenes de servicio Completadas</h5>
        </div>
        <div class="widget-content">
            <table class="table table-bordered">
                <thead>
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5">No hay OS Finalizadas.</td>
                        </tr>
                    <?php endif ?>
                </tbody>
            </table>
    ...
    <div class="widget-box0 widbox-blak">
        <div>
            <h5 class="cardHeader">Órdenes de Servicio en curso y en Espera de piezas</h5>
        </div>
        <div class="widget-content">
            <table class="table table-bordered">
                <thead>
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5">No hay OS Presupuesto.</td>
                        </tr>
                    <?php endif ?>
                </tbody>
            </table>
    ...
    <div class="widget-box0 widbox-blak">
        <div>
            <h5 class="cardHeader">Estatus de Vendas</h5>
        </div>
        <div class="widget-content">
            <table class="table table-bordered lanc-table">
                <thead>
                    <tr>
                        ...
                        <th class="acoes-col">Acciones</th>
                    </tr>
                </thead>
                <tbody>
    ...
    <div class="widget-box0 widbox-blak">
        <div>
            <h5 class="cardHeader">Últimos lanzamientos pendientes</h5>
        </div>
        <div class="widget-content">
            <table class="table table-bordered lanc-table">
                <thead>
                    <tr>
                        ...
                        <th class="descricao-col">Descripción</th>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="5">No se encontraron lanzamientos..</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
    ...
    <div class="AAA">
        <div class="widget-box0 widbox-blak">
            <div>
                <h5 class="cardHeader">Productos con Stock Mínimo Requerido</h5>
            </div>
            <div class="widget-content">
                <table class="table table-bordered">
                    <thead>
...
<div id="calendarModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        ...
        <h3 id="myModalLabel">Estatus Detallado de OS</h3>
    </div>
...
<div id="modal-excluir-os" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url() ?>index.php/os/excluir" method="post">
        ...
        <div class="modal-body">
            ...
            <h5 style="text-align: center">¿Realmente quieres eliminar esta OS?</h5>
        </div>
    ...
    $(document).ready(function() {
        ...
        var srcCalendar = new FullCalendar.Calendar(srcCalendarEl, {
            ...
            events: {
                ...
                failure: function() {
                    alert('¡No se pudo recuperar el calendario!');
                },
            },
