...
<script type="text/javascript" src="<?php echo base_url() ?>assets/trumbowyg/langs/es.js"></script>
                        ...
                        <div class="tab-pane active" id="tab1">
                            <div class="span12" id="divCadastrarOs">
                                <?php if ($custom_error == true) { ?>
                                    <div class="span12 alert alert-danger" id="divInfo" style="padding: 1%;">Información incompleta, revise los campos marcados con un asterisco o si ha seleccionado correctamente el cliente. <br /> Alternativamente, verifique si tiene registrado al cliente.</div>
                                <?php
                                } ?>
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span6" style="padding: 1%; margin-left: 0">
                                        <label for="descricaoProduto">
                                            <h4>Descripción general del Servicio</h4>
                                        </label>
