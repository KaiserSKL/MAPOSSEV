...
<div class="new122">
    ...
    <div class="span12" style="margin-left: 0">
        <form method="get" action="<?php echo base_url(); ?>index.php/os/gerenciar">
            ...
            <div class="span3">
                <input type="text" name="pesquisa" id="pesquisa" placeholder="Nombre del cliente a buscar" class="span12" value="<?=set_value('pesquisa')?>">
            </div>
            <div class="span2">
                <select name="status" id="" class="span12">
                    <option value="">Seleccionar estado</option>
                    <option value="Aberto" <?=$this->input->get('status') == 'Aberto' ? 'selected' : ''?>>Abierto</option>
                    ...
                    <option value="Em Andamento" <?=$this->input->get('status') == 'Em Andamento' ? 'selected' : ''?>>En curso</option>
            ...
            <div class="span3">
                <input type="text" name="data" autocomplete="off" id="data" placeholder="Fecha Inicial" class="span6 datepicker" value="<?=$this->input->get('data')?>">
                <input type="text" name="data2" autocomplete="off" id="data2" placeholder="Fecha Final" class="span6 datepicker" value="<?=$this->input->get('data2')?>">
            </div>
            <div class="span1">
            ...
            <div class="table-responsive">
                <table class="table table-bordered ">
                    ...
                    <tbody>
                        <?php if (!$results) {
                            echo '<tr>
                            <td colspan="10">No hay Ordenes de servicio registradas</td>
                            </tr>';
                        }
                ...
                .done(function(data) {
                    if (data.result == true) {
                        ...
                        Swal.fire({
                            type: "éxito",
                            title: "Éxito",
                            text: "Hubo un problema al intentar eliminar la notificación."
                        });
                    }
                });
        });
