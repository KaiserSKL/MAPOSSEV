                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <label for="saida" class="btn btn-default" style="margin-top: 5px;">Salida
                    ...
                    <div class="control-group">
                        <label for="Lucro" class="control-label">Ganancia</label>
                        <div class="controls">
                            <select id="selectLucro" name="selectLucro" style="width: 10.5em;">
                              <option value="markup">Margen</option>
                              <option value="margemLucro">Margen de Ganancia</option>
                            </select>
                    ...
                    <div class="control-group">
                        <label for="estoque" class="control-label">Existencia<span class="required">*</span></label>
                        <div class="controls">
                            <input id="estoque" type="text" name="estoque" value="<?php echo set_value('estoque'); ?>" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="estoqueMinimo" class="control-label">Existencia Minima</label>
                        <div class="controls">
                            <input id="estoqueMinimo" type="text" name="estoqueMinimo" value="<?php echo set_value('estoqueMinimo'); ?>" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="dsp" class="control-label">Datos Adicionales</label>
                        <div class="controls">
                            <input id="dsp" type="text" name="dsp" value="<?php echo set_value('dsp'); ?>" />
                        </div>
                    </div>
