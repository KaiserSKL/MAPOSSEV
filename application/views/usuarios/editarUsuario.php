        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding tab-content">
                ...
                <form action="<?php echo current_url(); ?>" id="formUsuario" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label for="telefone" class="control-label">Telefono<span class="required">*</span></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <i class="icon-exclamation-sign tip-top" title="Deje en blanco si no desea realizar cambios."></i>
                        </div>
                    </div>
                    ...
                    <!--DATA-->
                    <div class="control-group">
                        <label for="dataExpiracao" class="control-label">Expira en<span class="required">*</span></label>
                        <div class="controls">
