<div class="section">
  <p>1. Por favor, revise su configuración de <strong>PHP</strong> cumpla con los siguientes requisitos:</p>
  <hr />
  <div>
    <table>
      <thead>
  ...
  <div class="section">
    <p>2. Comprueba que las extensiones que se enumeran a continuación estén <strong>instaladas/habilitadas</strong> en tu servidor.:</p>
    <hr />
    <div>
      <table>
        <thead>
  ...
  <div class="section">
      <p>3. Asegúrese de tener permisos de <strong>lectura y escritura</strong> en los siguientes directorios y archivos:</p>
    <hr />
    <div>
      <table>
        <thead>
  ...
  <div class="panel-footer">
    <button <?php if (! $all_requirement_success) {
      ...
      form-next"><i class='fa fa-chevron-right'></i> Siguiente</button>
    </div>
